			...
			<Section>
				...
				<div style={{ display: "none"}}>
					<Trans
						...
						components={{
							githubLink: <VSCodeLink href="https://github.com/kakuka/icemark" />,
							redditLink: <VSCodeLink href="https://reddit.com/r/icemark" />,
							discordLink: <VSCodeLink href="https://discord.gg/icemark" />,
						}}
					/>
				</div>
