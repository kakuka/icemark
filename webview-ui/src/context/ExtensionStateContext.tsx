...
export interface ExtensionStateContextType extends ExtensionState {
	...
	setPreLoginBrowserEnabled: (value: boolean) => void
}
...
export const ExtensionStateContextProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	const [state, setState] = useState<ExtensionState>({
		...
		preLoginBrowserEnabled: false, // Enable browser pre-login functionality
	})
	...
	const contextValue: ExtensionStateContextType = {
		...
		preLoginBrowserEnabled: state.preLoginBrowserEnabled ?? false,
		setPreLoginBrowserEnabled: (value) => setState((prevState) => ({ ...prevState, preLoginBrowserEnabled: value })),
	}
