;(() => {
	...
	var Rn = {
		...
		get({ objects: e }, t, r) {
			return t == "toJSON"
				? Mn
				: Reflect.get(e.find((n) => Object.prototype.hasOwnProperty.call(n, t)) || {}, t, r)
		},
		set({ objects: e }, t, r, n) {
...
`
	...
	function kn(e, t) {
		...
		let s = () => {
			e._x_ignore ||
				e._x_ignoreSelf ||
				(n.inline && n.inline(e, t, i), (n = n.bind(n, e, t, i)), bt ? de.get(hr).push(n) : n())
		}
	...
	function _e(e, t, r, n = []) {
		switch (
			(e._x_bindings || (e._x_bindings = T({})), (e._x_bindings[t] = r), (t = n.includes("camel") ? Qn(t) : t), t)
		) {
			case "value":
				Un(e, r)
				break
	...
	function Un(e, t) {
		if (e.type === "radio")
			e.attributes.value === void 0 && (e.value = t),
				window.fromModel &&
					(typeof t == "boolean" ? (e.checked = ge(e.value) === t) : (e.checked = Rr(e.value, t)))
	...
	d("model", (e, { modifiers: t, expression: r }, { effect: n, cleanup: i }) => {
		...
		if (
			(t.includes("fill") &&
				([null, ""].includes(c()) || (e.type === "checkbox" && Array.isArray(c()))) &&
