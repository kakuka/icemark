...
export const toolGroups = ["read", "edit", "browser", "command", "mcp", "modes", "assistant_max", "prototype"] as const
...
export const globalSettingsSchema = z.object({
	...
	preLoginBrowserEnabled: z.boolean().optional(),
...
const globalSettingsRecord: GlobalSettingsRecord = {
	...
	preLoginBrowserEnabled: undefined,
...
export const typeDefinitions: TypeDefinition[] = [
	...
	{ schema: rooCodeSettingsSchema, identifier: "RooCodeSettings" },
