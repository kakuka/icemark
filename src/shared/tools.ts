...
export interface SaveResourceToolUse extends ToolUse {
	name: "save_resource"
...
export interface InitJobWorkDirToolUse extends ToolUse {
	name: "init_job_workdir"
	params: Partial<Pick<Record<ToolParamName, string>, "path" | "folder">>
}

export interface WebSearchToolUse extends ToolUse {
	name: "web_search"
	params: Partial<Pick<Record<ToolParamName, string>, "keyword_list" | "page_limit" | "search_on">>
}

export interface PrototypeToolUse extends ToolUse {
	name: "prototype"
	params: Partial<Pick<Record<ToolParamName, string>, "action" | "path" | "folder" | "arguments">>
}
...
export const TOOL_DISPLAY_NAMES: Record<ToolName, string> = {
	...
	save_resource: "save resources",
	init_job_workdir: "create directories",
...
export const TOOL_GROUPS: Record<ToolGroup, ToolGroupConfig> = {
	...
	browser: {
		tools: ["browser_action", "url_content_fetch", "web_search"],
	},
	command: {
	...
	assistant_max: {
		tools: ["save_resource", "init_job_workdir"],
	},
	prototype: {
		tools: ["prototype"],
	},
