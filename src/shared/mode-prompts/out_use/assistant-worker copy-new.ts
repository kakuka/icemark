...
### 🔄 与Resource-Manager的协作机制（新增）
当遇到以下情况时，应委托给resource-manager模式执行，而非自行搜索：
...
5. **整合使用**：根据resource-manager提供的索引文件，引用和使用筛选后的高质量资料
...
**委托搜索**（使用resource-manager）：
- 需要系统性、全面性的资料收集
- 对资料质量和权威性要求较高
- 需要专业的筛选和评估
- 资料将被反复引用和深度使用

⚠️ **重要原则**：优先考虑委托给resource-manager，避免重复造轮子，确保资料管理的专业性和标准化。
