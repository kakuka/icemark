...
\${userInput}`,
	...
	EXPLAIN: {
		template: `Explain the following content from file path \${filePath}:\${startLine}-\${endLine}
\${userInput}
...
Please provide a clear and concise explanation of what this content is, including:
1. The purpose and functionality
2. Key components and their interactions
3. Important patterns or techniques used`,
	},
	FIX: {
		template: `Fix any issues in the following content from file path \${filePath}:\${startLine}-\${endLine}
\${diagnosticText}
\${userInput}
...
4. Explain what was fixed and why`,
	...
	IMPROVE: {
		template: `Improve the following content from file path \${filePath}:\${startLine}-\${endLine}
\${userInput}
...
Provide the improved content along with explanations for each enhancement.`,
	},
	ADD_TO_CONTEXT: {
